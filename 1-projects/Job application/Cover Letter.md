...
I am writing to express my interest in the Software Engineer I position at Viator. I am drawn to your mission to be the leading marketplace for travel experiences and help people make lasting memories. 

I believe my experience in fullstack development, particularly with React, Node.js, and SQL, aligns with the requirements for this role - as demonstrated in my personal projects. Chalkr, an iOS climbing app (built with React Native/Expo, Firebase Auth, SQLite) [https://github.com/Portavion/Chalkr](https://github.com/Portavion/Chalkr). And Velock, a Santander Cycles search / availability tracker (React, Node.js/Express, PostgreSQL) [https://github.com/Portavion/velock](https://github.com/Portavion/velock). 

In my previous role as a Senior Transport Modeller at Arup, I gained valuable experience in data analysis and problem-solving. Additionally, my exposure to web development within the city modelling team provided me with practical experience in building data visualisation tools. 

I am attracted to Viator's remote-first, fast-paced environment and the opportunity to contribute to a platform that helps people explore travel experiences. I am a self-driven, proactive, and thrive in collaborative environments. I believe my ability to quickly learn new technologies will help me rapidly contribute to the team. 

I am confident that my skills in TypeScript, React,  SQL databases make me a good fit for this role, and I am excited for the opportunity to contribute to Viator's mission while improving my technical skills. 
...
### Tell us about a time when you hacked a system to your advantage
For a transport modelling project for Gatwick Airport, I had to develop a significantly larger model than the software was typically designed for(a 24-hour model with over 90 origin-destination pairs, compared to the usual 1-hour, 15-pair models) This caused the standard VBA COM interface, used for automating data inputs, to slow down to a crawl, with the import process taking upward of three hours. To solve this, I bypassed the standard interface and rewrote the necessary features with a set of Python scripts. I managed to reduce the import time to around 10 minutes and the scripts are now standard for all modelling projects. This optimisation was done by disabling software UI updates and refining the order of the import steps to minimise background db queries. As a result, we were able to perform more calibration and validation iterations and deliver a much higher quality model.
### Tell us about something you've done in the past that can be considered as evidence of exceptional ability
For a masterplan project or the principality of Monaco, we faced the challenge of transforming the heavily car-centric road network into a pedestrian friendly environment, al within the very space-constrained streets.

My task was to develop a design solution that would maximise pedestrian space and improve the overall urban experience, while also managing a geographically dispersed team effectively.

Leveraging my understanding of traffic modelling, I proposed an unconventional solution: a primarily one-way traffic system with strategic two-way bypasses. This approach allowed us to reclaim entire traffic lanes for wider pedestrian walkways and greenery. 
...
For a masterplan design project for the principality of Monaco. I was confronted with the challenge of converting a car heavy transport network into a pedestrian-friendly environment within very space-constrained streets. To tackle this, I came up with an unconventional one-way traffic system with strategic two-way bypasses, leveraging my traffic modelling expertise. This allowed us to reclaim entire traffic lanes for expanded pedestrian walkways and greenery. We were able to demonstrate the feasibility of the solution through rapid traffic modelling and the design significantly exceeded client expectations. This led to us winning the next design stage. Just as with the Gatwick project, where I hacked the software limitations with Python to drastically reduce import times, this project shows my ability to rapidly implement effective, unconventional solutions to complex problems.